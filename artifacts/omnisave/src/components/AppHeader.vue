    ...
    <div class="header-bar">
      <div class="header-inner">
        ...
        <div class="flex items-center gap-2 shrink-0">
          <button class="btn-subscribe hidden lg:flex" @click="subscribeOpen = true">
      ...
      <div v-if="mobileOpen" class="border-t border-white/[0.06] px-4 py-3 lg:hidden">
        ...
        <div class="flex flex-col gap-0.5">
          ...
          <button class="mobile-nav-item text-left" @click="subscribeOpen = true; mobileOpen = false">SUBSCRIBE</button>
